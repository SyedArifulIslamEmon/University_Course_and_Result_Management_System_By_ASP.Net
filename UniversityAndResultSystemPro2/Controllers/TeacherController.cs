...
namespace UniversityAndResultSystemPro2.Controllers
{
    public class TeacherController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Assign(CourseAssignment courseAssignment)
        {
            string msg = aTeacherManager.AssignCourseToTeacher(courseAssignment);
            //if(msg == "yes" || msg == "Course Already Assigned")
                ModelState.Clear(); 
            ViewBag.Message = msg;
            List<Department> departments = aDepartmentManager.GetAllDepartmentsInfo();
